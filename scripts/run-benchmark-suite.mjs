...
writeFileSync(join(root, "benchmarks", "suite-report.json"), `${JSON.stringify({ schema: "tidyrun.benchmark-suite/v1", commitSha, reports }, null, 2)}\n`, "utf8");
writeFileSync(join(root, "benchmarks", "suite-report.md"), `# TidyRun deterministic suite\n\nBenchmark commit: \`${commitSha}\`\n\n${reports.map(benchmarkMarkdown).join("\n\n---\n\n")}\n`, "utf8");
