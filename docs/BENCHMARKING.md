...
22,455 delivered (74% derived reduction) and 17,969 ms versus 8,495 ms total
end-to-end (53% lower), with equal verification parity for all three fixtures.
The repeated-work fixture alone measured 17,759 ms versus 8,274 ms with one
verified cache hit and 78 ms observed local optimizer overhead. Short commands
